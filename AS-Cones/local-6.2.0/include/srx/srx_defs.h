...
#define SRX_PROXY_RESTYPE_ASCONE    8
...
#define SRX_FLAG_ASCONE            8
#define SRX_FLAG_ROA_AND_ASPA     (SRX_FLAG_ROA | SRX_FLAG_ASPA)
#define SRX_FLAG_ROA_AND_ASCONE     (SRX_FLAG_ROA | SRX_FLAG_ASCONE)
...
#define SRX_FLAG_ROA_BGPSEC_ASPA_ASCONE  (SRX_FLAG_ROA | SRX_FLAG_BGPSEC | SRX_FLAG_ASPA | SRX_FLAG_ASCONE)
...
typedef struct {
  ...
  SRxResultSource resSourceASCONE;  // The source of the provided ASCONE result
...
typedef enum {
  ASCONE_RESULT_VALID        = 0,
  ASCONE_RESULT_INVALID      = 1,
  ASCONE_RESULT_UNDEFINED    = 2,
  ASCONE_RESULT_UNKNOWN      = 4,
  ASCONE_RESULT_UNVERIFIABLE = 8,
  //ASCONE_RESULT_INIT         = 0xffff,
} ASCONE_ValidationResult;

//ASCONE validation types as described in RFC draft-ietf-grow-rpki-as-cones-02
typedef enum {
  ASCONE_VALTYPE_LOOSE             = 0,
  ASCONE_VALTYPE_OPPORTUNISTIC     = 1,
  ASCONE_VALTYPE_ALMOSTSTRICT      = 2,
  ASCONE_VALTYPE_STRICT            = 3,
} ASCONE_ValidationType;
