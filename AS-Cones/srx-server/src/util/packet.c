                    ...
                    PacketHandlerType pHandlerType)
{
  ...
  while (keepGoing)
  {
    ...
    printf("Debug: packet.c - RECEIVED - pduLength: %u, basicLength: %u, hdr->length: %u\, hdr->type: %u\n", pduLength, basicLength, hdr->length, hdr->type);
    ...
    printf("Debug: packet.c - pduLength: %u, basicLength: %u, hdr->length: %u\, hdr->type: %u\n", pduLength, basicLength, hdr->length, hdr->type);
