...
bool sendVerifyNotification(ServerSocket* srvSoc, ServerClient* client,
                            ...
                            uint8_t aspaResult, uint8_t asconeResult, bool useQueue)
{
  bool retVal = true;
  ...
  if (resultType == 4)
  {
    printf("\n\nXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX WARNING XXXXXXXXXXXXXXXXXXXXXXXXXXXXX\n\n");
    printf("Debug: SENDING SRX RESULT TYPE 4 ASPA!!!!!\n\n");
    printf("resultType: %u, aspaResult: %u", resultType, aspaResult);
    printf("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX WARNING XXXXXXXXXXXXXXXXXXXXXXXXXXXXX\n\n");
  }

  if ((resultType & SRX_FLAG_ASCONE) == SRX_FLAG_ASCONE)
  {
    printf("\n\nXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX WARNING XXXXXXXXXXXXXXXXXXXXXXXXXXXXX\n\n");
    printf("Debug: SENDING SRX RESULT TYPE 8 ASCONE!!!!!\n\n");
    printf("resultType: %u, asconeResult: %u", resultType, asconeResult);
    printf("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX WARNING XXXXXXXXXXXXXXXXXXXXXXXXXXXXX\n\n");
  }
  ...
  pdu->asconeResult = asconeResult;
  pdu->length        = htonl(length);
  pdu->updateID      = htonl(updateID);

  if (asconeResult == 0)
  {
    printf("Debug: asconeResult is 0!!!!\n");
    //kill(getpid(), SIGSEGV);
  }
  

  printf("Debug: srx_packet_sender.c - asconeResult: %u\n", pdu->asconeResult);
