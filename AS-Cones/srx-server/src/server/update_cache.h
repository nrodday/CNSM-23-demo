...
bool modifyUpdateCacheResultWithAsconeVal(UpdateCache* self, SRxUpdateID* updateID,
                        SRxResult* srxResult_ascone);

void process_ASPA_EndOfData(UpdateCache* self, 
                            int (*cb)(void* uCache, void* hldr, uint32_t uid, uint32_t pid, time_t), 
                            void* rpkiHandler);

void process_ASCONE_EndOfData(UpdateCache* self, 
