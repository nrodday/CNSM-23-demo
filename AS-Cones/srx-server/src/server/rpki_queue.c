              ...
              e_RPKI_QUEUE_REASON reason, SRxUpdateID* updateID)
{
  ...
  //@TODO: Sometimes RQ_ASPA is set even if ASPA is disabled. ASPA_END_OF_DATA seems to change the aspa result.
  /*if ((reason & RQ_ASPA) == RQ_ASPA)
  {
    printf("Debug: RQ_ASPA called!!\n");
    kill(getpid(), SIGSEGV);
  }*/
